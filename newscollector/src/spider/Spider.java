...
public static void main(String[] args) {
	...
	Document doc = ParsingEngine.getDocument("https://portaldoholanda.com.br/fdn/em-manaus-supostos-membros-da-fdn-sao-presos-com-armas-escondidas-em-carro");
	System.out.println(doc.title());
	System.out.println( ParsingEngine.containsBlackList(doc.title()));
	//System.out.println( ParsingEngine.containsBlackList(doc.text()) );
		 ...
		 * //System.out.println("Links percorridos: " +
		 * ParsingEngine.linksPercorridos.size());
		 * 
		 * }
		 * 
